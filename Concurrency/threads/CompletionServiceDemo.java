...
public enum CompletionServiceDemo {
  ...
  public static void main(String[] args) {
    ...
    ReportRequest faceRequest =
        new ReportRequest("Face", service);
    ReportRequest onlineRequest =
        new ReportRequest("Online", service);
    ReportProcessor processor =
        new ReportProcessor(service);
    System.out.printf(
        "Main: Creating and starting the Threads%n");
    ...
    try {
      System.out.printf(
          "Main: Waiting for the report generators.%n");
      faceThread.join();
      onlineThread.join();
      ...
      while (!end) {
        try {
          ...
          if (result != null) {
            ...
            System.out.printf(
                "ReportReceiver: Report Received: %s%n",
                report);
          }
