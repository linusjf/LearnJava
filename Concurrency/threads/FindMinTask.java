...
public class FindMinTask implements Callable<Integer> {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < numbers.length; i++) numbers[i] = Math.abs(random.nextInt() % Integer.MAX_VALUE);
    try {
  ...
  public String toString() {
    return "FindMinTask(numbers=" + java.util.Arrays.toString(this.numbers) + ", startIndex=" + this.startIndex + ", endIndex=" + this.endIndex + ", executorService=" + this.executorService + ")";
  }
}
