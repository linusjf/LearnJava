...
public class RunnableHelloCount implements Runnable {
  ...
  public boolean equals(Object o) {
    ...
    if (this$thread1 == null ? other$thread1 != null : !this$thread1.equals(other$thread1)) return false;
    Object this$thread2 = this.thread2;
    Object other$thread2 = other.thread2;
    if (this$thread2 == null ? other$thread2 != null : !this$thread2.equals(other$thread2)) return false;
  ...
  public String toString() {
    return "RunnableHelloCount(thread1=" + this.thread1 + ", thread2=" + this.thread2 + ", random=" + this.random + ")";
  }
}
