...
public enum AsynchronousExample {
  ...
  public static void main(String[] args) {
    ...
    FolderProcessor apps = new FolderProcessor(
        "/data/data/com.termux/files/home/", "log");
    ...
    results = system.join();
    System.out.printf("System: %d files found.%n",
                      results.size());

    results = apps.join();
    System.out.printf("Apps: %d files found.%n",
                      results.size());

    results = documents.join();
    System.out.printf("Documents: %d files found.%n",
                      results.size());
  }

  static class FolderProcessor
      extends RecursiveTask<List<String>> {
    ...
    protected List<String> compute() {
      ...
      if (content != null) {
        ...
        if (tasks.size() > TASK_THRESHOLD)
          System.out.printf("%s: %d tasks ran.%n",
