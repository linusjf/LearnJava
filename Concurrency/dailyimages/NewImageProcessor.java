...
public class NewImageProcessor {
  ...
  public CompletableFuture<ImageInfo> findImageData(ImageInfo info) {
    ...
    return getAsync2(info.getImagePath(), HttpResponse.BodyHandlers.ofByteArray())
  ...
  public void process(ImageInfo info) {
    ...
    if (PRINT_MESSAGE) {
      System.out.println("process called by " + Thread.currentThread() + ", date: " + infoDate);
    }
    if (SAVE_FILE)
      try {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof NewImageProcessor)) return false;
    ...
    if (this$executor1 == null ? other$executor1 != null : !this$executor1.equals(other$executor1))
      return false;
    Object this$executor2 = this.executor2;
    Object other$executor2 = other.executor2;
    if (this$executor2 == null ? other$executor2 != null : !this$executor2.equals(other$executor2))
      return false;
    ...
    if (this$failureCount == null
        ...
        : !this$failureCount.equals(other$failureCount)) return false;
    Object this$imageDir = this.imageDir;
    Object other$imageDir = other.imageDir;
    if (this$imageDir == null ? other$imageDir != null : !this$imageDir.equals(other$imageDir))
      return false;
