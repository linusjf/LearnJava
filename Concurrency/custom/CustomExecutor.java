...
public class CustomExecutor extends ThreadPoolExecutor {
  ...
  public static void main(String[] args) {
    CustomExecutor myExecutor = new CustomExecutor(2, 4, 1000, TimeUnit.MILLISECONDS, new LinkedBlockingDeque<Runnable>());
  ...
  public boolean equals(Object o) {
    ...
    if (this$startTimes == null ? other$startTimes != null : !this$startTimes.equals(other$startTimes)) return false;
    return true;
  }
