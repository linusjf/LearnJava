...
public class TestByteToHex {
  public static void main(String[] args) {
    ...
    String byteString =
        "@#£&_-()=%?!/:'*\"[]{}<>^¡¿~™®©¢¥€$123456789003356788990335688335678888))5778889===66://))*£&'/!!))))?:/!??????!//!!!!!!!!!?????      dffvbbfrewshjoohgvvvzscvbmmmxxvffew236889uygghhbhjkiu65fvbhbbvvvvvdew13yhgftggjioo9hhgggggvvgdWeryhhhDFGJKYRESCHJKKOKVVCSSDVNJHFDSSSGHIJJH";
