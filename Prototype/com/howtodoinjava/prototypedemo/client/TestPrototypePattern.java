...
public enum TestPrototypePattern {
  ...
  public static void main(String[] args) {
    try {
      PrototypeCapable moviePrototype = PrototypeFactory.getInstance(
        ModelType.MOVIE
      );
      System.out.println(moviePrototype);

      PrototypeCapable albumPrototype = PrototypeFactory.getInstance(
        ModelType.ALBUM
      );
      System.out.println(albumPrototype);

      PrototypeCapable showPrototype = PrototypeFactory.getInstance(
        ModelType.SHOW
      );
