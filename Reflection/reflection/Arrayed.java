...
public enum Arrayed {
  ...
  public static void main(String... args) {
    try {
      ...
      System.out.println(
        "strArrayOne[3] (not initialized) : " + Array.get(strArrayOne, 3)
      );
      ...
      for (int i = 0; i < Array.getLength(intArrayOne); ++i) {
        System.out.println(
          "intArrayOne[" + i + "] : " + Array.getInt(intArrayOne, i)
        );
      }
      ...
      System.out.println(
        "stringArrayClassUsingInstance is array: " +
      ...
      System.out.println(
        "byteArrayUsingClassForName is array: " +
          byteArrayUsingClassForName.isArray()
      );

      // or [Ljava.lang.String
      Class<?> stringArrayClassUsingClassForName = Class.forName(
        "[Ljava.lang.String;"
      );
      System.out.println(
        "stringArrayClassUsingClassForName is array: " +
          stringArrayClassUsingClassForName.isArray()
      );
      Class<? extends Object> stringArrayClassUsingDoubleLoop = Array.newInstance(
        String.class,
        0
      )
        .getClass();
      ...
      try {
        Class<? extends Object> byteArrayClassUsingClassForName = Class.forName(
          "byte"
        );
      ...
      Class<? extends Object> byteArrayClassUsingDoubleLoop = Array.newInstance(
        byteClass,
        0
      )
        .getClass();
      System.out.println(
        "byteArrayClassUsingClassForName is array: " +
          byteArrayClassUsingDoubleLoop.isArray()
      );
      System.out.println(byteArrayClassUsingDoubleLoop);

      System.out.println(
        "Component class: " + byteArrayClassUsingDoubleLoop.getComponentType()
      );
