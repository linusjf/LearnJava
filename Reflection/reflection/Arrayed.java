...
public enum Arrayed {
  ...
  public static void main(String... args) {
    try {
      ...
      System.out.println(
          "stringArrayClassUsingInstance is array: " + stringArrayClassUsingInstance.isArray());

      // using class for name and passing [I
      Class<?> byteArrayUsingClassForName = Class.forName("[B");
      System.out.println(
          "byteArrayUsingClassForName is array: " + byteArrayUsingClassForName.isArray());
      ...
      System.out.println(
          "byteArrayClassUsingClassForName is array: " + byteArrayClassUsingDoubleLoop.isArray());
