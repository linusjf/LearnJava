...
public final class SCryptUtil {  // NOPMD
  ...
  public static String scrypt(String passwd,
    ...
    try {
      ...
      final byte[] derived =
          SCrypt.scrypt(passwd.getBytes("UTF-8"),
                        salt,
                        enCPUCost,
                        rmemCost,
                        p,
      ...
      final String params = Long.toString(
          log2(enCPUCost) << 16L | rmemCost << 8 | p, 16);
  ...
  public static boolean check(String passwd,
    ...
    try {
      ...
      final byte[] derived1 = SCrypt.scrypt(
          passwd.getBytes("UTF-8"), salt, n, r, p, 32);
