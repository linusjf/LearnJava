...
public final class RequestHandlerUtils {
  ...
  static String extractURL(String requestString) {
    ...
    String urlString = requestString.substring(
  ...
  static String computeLogicalFilePrefix(String urlString) {
    ...
    String fileName =
        urlString.substring(0, fileExtensionIndex);
  ...
  static String computeLogicalFileExtension(
      String urlString) {
    int fileExtensionIndex = urlString.lastIndexOf('.');
  ...
  public static String extractRequest(
      String requestString) {
    // Get the Request type
    return requestString.substring(
        0, requestString.indexOf(' '));
  }
