...
@Fork(1)
@State(Scope.Thread)
public class StatesDAG {

  /** WARNING: THIS IS AN EXPERIMENTAL FEATURE, BE READY FOR IT BECOME REMOVED WITHOUT NOTICE! */
   ...
   * referenced @State before current @State is done with it.
   */
  ...
  public static void main(String[] args) throws RunnerException {
    Options opt =
        new OptionsBuilder().include(StatesDAG.class.getSimpleName()).build();
    new Runner(opt).run();
  }
}
