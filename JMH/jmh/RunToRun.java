...
public class RunToRun {
  ...
  @Benchmark
  @Fork(5)
  public void fork1(SleepyState s) throws InterruptedException {
    TimeUnit.MILLISECONDS.sleep(s.sleepTime);
  }

  @Benchmark
  @Fork(20)
  public void fork2(SleepyState s) throws InterruptedException {
    TimeUnit.MILLISECONDS.sleep(s.sleepTime);
  }
  ...
  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
                      .include(RunToRun.class.getSimpleName())
                      .warmupIterations(0)
