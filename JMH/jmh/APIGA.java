...
public class APIGA {
  ...
  public static class Chromosome implements Comparable<Chromosome> {
    ...
    public String toString() {
      return "-XX:FreqInlineSize=" + freqInlineSize + " -XX:InlineSmallCode="
          + inlineSmallCode + " -XX:MaxInlineLevel=" + maxInlineLevel
    ...
    public Chromosome crossover(Chromosome other) {
      ...
      result.minInliningThreshold = (Math.random() < CROSSOVER_PROB)
                                        ? this.minInliningThreshold
                                        : other.minInliningThreshold;
    ...
    public Chromosome mutate() {
      ...
      result.maxRecursiveInlineLevel =
          (int)randomChange(maxRecursiveInlineLevel);
