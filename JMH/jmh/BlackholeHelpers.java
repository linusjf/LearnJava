...
@Fork(1)
@State(Scope.Thread)
public class BlackholeHelpers {

  /**
   * Sometimes you need the black hole not in @Benchmark method, but in helper methods, because you
   * want to pass it through to the concrete implementation which is instantiated in helper methods.
   * In this case, you can request the black hole straight in the helper method signature. This
  ...
  public static void main(String[] args) throws RunnerException {
    Options opt = new OptionsBuilder()
                      .include(BlackholeHelpers.class.getSimpleName())
                      .build();
    new Runner(opt).run();
  }
}
