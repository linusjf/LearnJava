...
public enum Main {
  ...
  public static void main(String[] args) {
    ...
    final
    Engineer shailesh = new Engineer(
      1010L,
      "Shailesh",
      "Engineer",
      Department.ENG
    ...
    workLoad.getWorkList()
      .stream()
      .forEach(work -> rachelle.assignWork(rachelle, work));
