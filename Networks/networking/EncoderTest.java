...
public final class EncoderTest {
  ...
  public static void main(String[] args) {
    try {
      ...
      System.out.println(URLEncoder.encode("This%string%has%percent%signs", UTF8));
      ...
      System.out.println(URLEncoder.encode("This\"string\"has\"quote\"marks", UTF8));
      ...
      System.out.println(URLEncoder.encode("This(string)has(parentheses)", UTF8));
      System.out.println(URLEncoder.encode("This.string.has.periods", UTF8));
      System.out.println(URLEncoder.encode("This=string=has=equals=signs", UTF8));
      System.out.println(URLEncoder.encode("This&string&has&ampersands", UTF8));
      System.out.println(URLEncoder.encode("Thiséstringéhasé non-ASCII characters", UTF8));
