...
public final class IPCharacteristics {
  ...
  private static void handleWildcardAddress(
      InetAddress address) {
  ...
  private static void handleLoopbackAddress(
      InetAddress address) {
  ...
  private static void handleLocalGlobalAddress(
      InetAddress address) {
  ...
  private static void handleCastAddress(
      InetAddress address) {
    if (address.isMulticastAddress()) {
      if (address.isMCGlobal()) {
        ...
        System.out.println(
            address + " is a site wide multicast address.");
