...
public class RequestProcessor implements Runnable {
  ...
  public RequestProcessor(
    ...
    try {
      ...
      LOGGER.info(
        "Error getting canonical root directory: %s",
        ex.getMessage()
      );
    }
    if (root == null) this.rootDirectory =
      rootDirectory; else this.rootDirectory = root;
  ...
  public void run() {
    try (
      ...
      if ("GET".equals(method)) handleGet(tokens, raw, out); else {
