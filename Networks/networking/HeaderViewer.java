  ...
  public static void main(String[] args) {
    for (String arg : args) {
      try {
        ...
        if (uc.getContentEncoding() != null) System.out.println(
          "Content-encoding: " + uc.getContentEncoding()
        );
        if (uc.getDate() != 0) System.out.println(
          "Date: " + new Date(uc.getDate())
        );
        if (uc.getLastModified() != 0) System.out.println(
          "Last modified: " + new Date(uc.getLastModified())
        );
        if (uc.getExpiration() != 0) System.out.println(
          "Expiration date: " + new Date(uc.getExpiration())
        );
        if (uc.getContentLength() != -1) System.out.println(
